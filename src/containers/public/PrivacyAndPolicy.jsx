                      ...
                      <div className="row justify-content-center">
                          <div className="col-lg-8 text-center">
                              <h2 className="h1 mb-2">
                                  Privacy Policy for Codemarka Inc
                              </h2>
                              <h6 className="font-weight-light text-muted">
                                  Last updated: Jun 25th, 2020
                              </h6>
                          </div>
                      </div>
                  </div>
              ...
              <div className="container">
                  <div className="row row-grid justify-content-between">
                      ...
                      <p>
                          ...
                          and/or collect in codemarka. This policy is not
                          applicable to any information collected offline or via
                          channels other than this website. Our Privacy Policy
                      ...
                      <p>
                          codemarka follows a standard procedure of using log
                      ...
                      <p>
                          Like any other website, codemarka uses 'cookies'.
                      ...
                      <p>
                          ...
                          for each of the advertising partners of codemarka.
                      </p>
                      ...
                      <p>
                          ...
                          links that appear on codemarka, which are sent
                      ...
                      <p>
                          Note that codemarka has no access to or control over
                      ...
                      <p>
                          codemarka's Privacy Policy does not apply to other
                      ...
                      <p>
                          ...
                          children while using the internet. We encourage
                          parents and guardians to observe, participate in,
                          and/or monitor and guide their online activity.
                      </p>

                      <p>
                          codemarka does not knowingly collect any Personal
